...
HD_PWD='D:/vivado_projects/Project_A/Project_A.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log asynchronous_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source asynchronous_fifo.tcl
